...
git clone https://github.com/khanhnguyendev/developerFolio.git
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/khanhnguyendev/developerFolio/wiki/Github-Setup-For-Open-Source-Projects).
...
const greeting = {
  ...
  resumeLink: "https://khanhnguyencv.s3.ap-northeast-1.amazonaws.com/%5BCV-JAVA%5D+NGO+KHANH+NGUYEN.pdf"
};
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/khanhnguyendev/developerFolio)
